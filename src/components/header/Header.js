            ...
            <div className="row">
                ...
                <div className="right_menu_header col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                    <div className="btn-group" role="group">
                        <button type="button" className="col-3 btn btn-muted mx-2" click="onSearch"><i class="fas fa-search"></i></button>
                        <button type="button" className="col-3 btn btn-muted mx-2"><i class="fas fa-microphone"></i></button>
                        <button type="button" className="col-3 btn btn-muted mx-2"><i class="fa fa-th" aria-hidden="true"></i></button>
                        <button type="button" className="col-3 btn btn-muted mx-2"><i class="fa fa-bell" aria-hidden="true"></i></button>
